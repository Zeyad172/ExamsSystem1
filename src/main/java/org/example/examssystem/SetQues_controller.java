...
public class SetQues_controller implements Initializable {
    ...
    public ArrayList<Questions>Question_Arr=new ArrayList<>(Collections.nCopies(50, null));
...
//        }
    ...
    public void Delete_Button(ActionEvent actionEvent) {
        ...
        Alarm.setText("This question is deleted successfully(please Enter another one.)");
    }
}