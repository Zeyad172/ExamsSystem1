...
public class PastResultController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create("http://192.168.0.100:8080/users/setButtons")).GET().build();
        ...
        for (String bName : ButtonNames) {
            ...
            b.setOnAction(e -> {
                ...
                HttpRequest request2 = HttpRequest.newBuilder().uri(URI.create("http://192.168.0.100:8080/users/setButtonAction/"+b.getText())).GET().build();
